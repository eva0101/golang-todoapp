...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_eva0101_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_features_tasks_transport_http.DTOTaskResponse"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        "github_com_eva0101_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Сделать до четверга дз по математике"
                },
                "id": {
                    "type": "integer",
                    "example": 15
        ...
        "internal_features_tasks_transport_http.DTOTaskResponse": {
            "type": "object",
            "properties": {
                "author_user_id": {
                    "type": "integer",
